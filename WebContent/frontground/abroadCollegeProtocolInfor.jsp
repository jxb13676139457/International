     ...
     <div class="port_inner">
		...
		<div class="main-top" style="padding-top:20px">
	       ...
	       <div class="pb_title_wrapper">
		       <h1 class="pb_title"><b style="text-align:center">国外院校协议的信息</b></h1>
               <div class="clear"></div>
		   ...
		   <div  style="text-align:center">
		       <s:if test="#status==1"> 
                   <c:if test="${totalPage>0}">
                         [<a href="priorAbroadCollegeAction!getAbroadCollegeProtocolInfor?pageNo=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorAbroadCollegeAction!getAbroadCollegeProtocolInfor?pageNo=${currentPage-1}"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorAbroadCollegeAction!getAbroadCollegeProtocolInfor?pageNo=${currentPage+1}"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorAbroadCollegeAction!getAbroadCollegeProtocolInfor?pageNo=${totalPage}"><b>尾页</b></a>]	
                  ...
                  <s:else>
                   ...
                   <c:if test="${totalPage>0}">
                         [<a href="priorAbroadCollegeAction!searchAbroadCollegeProtocol?pageNo=1 & temp=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorAbroadCollegeAction!searchAbroadCollegeProtocol?pageNo=${currentPage-1} & temp=1"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorAbroadCollegeAction!searchAbroadCollegeProtocol?pageNo=${currentPage+1} & temp=1"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorAbroadCollegeAction!searchAbroadCollegeProtocol?pageNo=${totalPage} & temp=1"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
