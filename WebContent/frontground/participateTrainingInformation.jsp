          ...
          <div class="container"> 		 
			   <div class="service_wrapper_holder">	
                   ...
                   <div class="service_wrapper">
				     <div class="four columns">
					   <div class="image_shadow">
					     <a href="priorEnglishAgencyAction!getParticipateSimulationExamInfor?status=1"><img src="images/icons/s4.png" class="scale-with-grid"/></a>
					   </div>
				      <div class="service_wrapper_inner"> 	      
					    
				            <h5><a href="priorEnglishAgencyAction!getParticipateSimulationExamInfor?status=1"> <b> 雅思模拟考试信息</b>  </a></h5>
                   ...
                   <div class="service_wrapper">
				     <div class="four columns">
					   <div class="image_shadow">
					     <a href="priorEnglishAgencyAction!getParticipateFormalExamViewInfor?status=1"><img src="images/icons/s3.png" class="scale-with-grid"/></a>
					   </div>
				      <div class="service_wrapper_inner"> 	      
					    
				            <h5><a href="priorEnglishAgencyAction!getParticipateFormalExamViewInfor?status=1"> <b>雅思正式考试信息</b> </a></h5>
     ...
     <div class="port_inner">
		...
		<div class="main-top" style="padding-top:20px">
	       ...
	       <div class="pb_title_wrapper">
		       <h1 class="pb_title"><b style="text-align:center">参与雅思培训的参与表信息</h1>
               <div class="clear"></div>
              ...
              <form action="priorEnglishAgencyAction!searchParticipateTrainingInfor" method="post">
			    ...
			    <button type="submit"  class="btn btn-default"  style="border-width:2px;width:80px;heigth:30px">搜索</button>
			     	    ...
			     	    <button type="button" class="btn btn-default" style="width:100px;height:33px">
                            <a href="priorEnglishAgencyAction!getParticipateTrainingInfor?status=1">显示全部</b></a></button>
                            
			     <s:if test='#session.type=="other"'>
			      <button type="button"  class="btn btn-default"  style="width:80px;height:33px">
                            <a href="priorDownloadExcelAction!exportParticipateTrainingExcel?searchName=${searchInformation }">导出</a></button>
               	</s:if>
		   ...
		   <div  style="text-align:center">
		       <s:if test="#status==1"> 
                   <c:if test="${totalPage>0}">
                         [<a href="priorEnglishAgencyAction!getParticipateTrainingInfor?pageNo=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorEnglishAgencyAction!getParticipateTrainingInfor?pageNo=${currentPage-1}"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorEnglishAgencyAction!getParticipateTrainingInfor?pageNo=${currentPage+1}"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorEnglishAgencyAction!getParticipateTrainingInfor?pageNo=${totalPage}"><b>尾页</b></a>]	
                    ...
                    <s:else>
                     <c:if test="${totalPage>0}">
                         [<a href="priorEnglishAgencyAction!searchParticipateTrainingInfor?pageNo=1  & temp=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorEnglishAgencyAction!searchParticipateTrainingInfor?pageNo=${currentPage-1}  & temp=1"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorEnglishAgencyAction!searchParticipateTrainingInfor?pageNo=${currentPage+1}  & temp=1"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorEnglishAgencyAction!searchParticipateTrainingInfor?pageNo=${totalPage}  & temp=1"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
