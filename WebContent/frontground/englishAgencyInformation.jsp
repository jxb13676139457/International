     ...
     <div class="port_inner">
		...
		<div class="main-top" style="padding-top:20px">
	       ...
	       <div class="pb_title_wrapper">
		       <h1 class="pb_title"><b style="text-align:center">雅思协议的信息</b></h1>
               <div class="clear"></div>
        	  ...
        	  <input type="text" style="border-width:2px;width:200px;heigth:30px" name="searchInformation"  placeholder="请输入关键字">
			    <button type="submit"  class="btn btn-default"  style="border-width:2px;width:80px;heigth:30px">搜索</button>
			     	    ...
			     	    <button type="button" class="btn btn-default" style="width:100px;height:33px">
                            <a href="priorEnglishAgencyAction?status=1">显示全部</b></a></button>
		   ...
		   <div  style="text-align:center">
		       <s:if test="#status==1"> 
                   <c:if test="${totalPage>0}">
                         [<a href="priorEnglishAgencyAction?pageNo=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorEnglishAgencyAction?pageNo=${currentPage-1}"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorEnglishAgencyAction?pageNo=${currentPage+1}"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorEnglishAgencyAction?pageNo=${totalPage}"><b>尾页</b></a>]	
                  ...
                  <s:else>
                   ...
                   <c:if test="${totalPage>0}">
                         [<a href="priorEnglishAgencyAction!searchAgencyProtocol?pageNo=1 & temp=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorEnglishAgencyAction!searchAgencyProtocol?pageNo=${currentPage-1} & temp=1"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorEnglishAgencyAction!searchAgencyProtocol?pageNo=${currentPage+1} & temp=1"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorEnglishAgencyAction!searchAgencyProtocol?pageNo=${totalPage} & temp=1"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
                  </s:else>
                  </div>
