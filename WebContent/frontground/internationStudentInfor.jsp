          ...
          <div class="container"> 		 
			   <div class="service_wrapper_holder">	
                   ...
                   <div class="service_wrapper">
				     <div class="four columns">
					   <div class="image_shadow">
					     <a href="priorStudentAction!showOverseasStudent"><img src="images/icons/s2.png" class="scale-with-grid"/></a>
					   </div>
				      <div class="service_wrapper_inner"> 	      
					    
				            <h5><a href="priorStudentAction!showOverseasStudent"> <b>出国学生的信息</b> </a></h5>
                   ...
                   <div class="service_wrapper">
				     <div class="four columns">
					   <div class="image_shadow">
					     <a href="priorStudentAction!showStudentActivity"><img src="images/icons/s3.png" class="scale-with-grid"/></a>
					   </div>
				      <div class="service_wrapper_inner"> 	      
					    
				            <h5><a href="priorStudentAction!showStudentActivity"> <b>学生活动的信息</b> </a></h5>
		   ...
		   <div  style="text-align:center">
		       <s:if test="#status==1"> 
                   <c:if test="${totalPage>0}">
                         [<a href="priorStudentInformationAction?pageNo=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorStudentInformationAction?pageNo=${currentPage-1}"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorStudentInformationAction?pageNo=${currentPage+1}"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorStudentInformationAction?pageNo=${totalPage}"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
                      </s:if>
                      <s:else>
                         <c:if test="${totalPage>0}">
                         [<a href="priorStudentInformationAction!searchStudent?pageNo=1 & temp=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorStudentInformationAction!searchStudent?pageNo=${currentPage-1} & temp=1"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorStudentInformationAction!searchStudent?pageNo=${currentPage+1} & temp=1 "><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorStudentInformationAction!searchStudent?pageNo=${totalPage} & temp=1"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
