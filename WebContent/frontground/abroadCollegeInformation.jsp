     ...
     <div class="port_inner">
		...
		<div class="main-top" style="padding-top:20px">
	       ...
	       <div class="pb_title_wrapper">
		       <h1 class="pb_title"><b style="text-align:center">国外院校的信息</b></h1>
               <div class="clear"></div>
	...
	<!--       <div class="main-body_list">
              ...
              <form action="priorAbroadCollegeAction!searchAbroadCollegeInfor" method="post">
               ...
               <input type="text" style="border-width:2px;width:200px;heigth:30px" name="searchInformation"  placeholder="请输入关键字">
			    <button type="submit" class="btn btn-default"  style="border-width:2px;width:80px;heigth:30px"><b>搜索</b></button>
			     
			     <button type="button" class="btn btn-default" style="width:100px;height:33px">
                            <a href="priorAbroadCollegeAction!getAbroadCollegeInfor?status=1">显示全部</b></a></button>
		       ...
		       <s:if test="#1==1"> 
                   <c:if test="${totalPage>0}">
                         ...
                         <c:if test="${currentPage>1}">
                             [<a href="priorAbroadCollegeAction!getAbroadCollegeInfor?pageNo=${currentPage-1}"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorAbroadCollegeAction!getAbroadCollegeInfor?pageNo=${currentPage+1}"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorAbroadCollegeAction!getAbroadCollegeInfor?pageNo=${totalPage}"><b>尾页</b></a>]	
                     ...
                     <s:else>
                         ...
                         <c:if test="${totalPage>0}">
                         [<a href="priorAbroadCollegeAction!searchAbroadCollegeInfor?pageNo=1 & temp=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorAbroadCollegeAction!searchAbroadCollegeInfor?pageNo=${currentPage-1} & temp=1"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorAbroadCollegeAction!searchAbroadCollegeInfor?pageNo=${currentPage+1} & temp=1"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorAbroadCollegeAction!searchAbroadCollegeInfor?pageNo=${totalPage} & temp=1"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
                     </s:else>
                  </div>
