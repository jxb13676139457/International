     ...
     <div class="port_inner">
		...
		<div class="main-top" style="padding-top:20px">
	       ...
	       <div class="pb_title_wrapper">
		       <h1 class="pb_title"><b style="text-align:center">国外院校活动的信息</b></h1>
               <div class="clear"></div>
	      ...
	      <!--  <div class="main-body_list">
	           <form action="priorAbroadCollegeAction!searchAbroadCollegeActivitiesInfor" method="post">            
			    ...
			    <button type="submit" class="btn btn-default"  style="border-width:2px;width:80px;heigth:30px"> <i class="icon_search"></i>&nbsp;&nbsp;搜索</button>
			    
			     <button type="button" class="btn btn-default" style="width:100px;height:33px">
                            <a href="priorAbroadCollegeAction?status=1">显示全部</b></a></button>
		   ...
		   <div  style="text-align:center">
		       <s:if test="#status==1"> 
                   <c:if test="${totalPage>0}">
                         [<a href="priorAbroadCollegeAction?pageNo=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorAbroadCollegeAction?pageNo=${currentPage-1}"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorAbroadCollegeAction?pageNo=${currentPage+1}"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorAbroadCollegeAction?pageNo=${totalPage}"><b>尾页</b></a>]	
                  ...
                  <s:else>
                    <c:if test="${totalPage>0}">
                         [<a href="priorAbroadCollegeAction!searchAbroadCollegeActivitiesInfor?pageNo=1 & temp=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorAbroadCollegeAction!searchAbroadCollegeActivitiesInfor?pageNo=${currentPage-1} & temp=1"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorAbroadCollegeAction!searchAbroadCollegeActivitiesInfor?pageNo=${currentPage+1} & temp=1"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorAbroadCollegeAction!searchAbroadCollegeActivitiesInfor?pageNo=${totalPage} & temp=1"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
