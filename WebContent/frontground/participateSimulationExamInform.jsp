     ...
     <div class="port_inner">
		...
		<div class="main-top" style="padding-top:20px">
	       ...
	       <div class="pb_title_wrapper">
		       <h1 class="pb_title"><b style="text-align:center">参与雅思模拟考试的信息</b></h1>
               <div class="clear"></div>
	       ...
	       <div class="main-body_list">
			    ...
			    <button type="submit" class="btn btn-default" style="border-width:2px;width:80px;heigth:30px">搜索</button>
			     	    ...
			     	    <button type="button" class="btn btn-default" style="width:100px;height:33px">
                            <a href="priorEnglishAgencyAction!getParticipateSimulationExamInfor?status=1">显示全部</b></a></button>
		   ...
		   <div  style="text-align:center">
		       <s:if test="#status==1"> 
                   <c:if test="${totalPage>0}">
                         [<a href="priorEnglishAgencyAction!getParticipateSimulationExamInfor?pageNo=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorEnglishAgencyAction!getParticipateSimulationExamInfor?pageNo=${currentPage-1}"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorEnglishAgencyAction!getParticipateSimulationExamInfor?pageNo=${currentPage+1}"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorEnglishAgencyAction!getParticipateSimulationExamInfor?pageNo=${totalPage}"><b>尾页</b></a>]	
                    ...
                    <s:else>
                      ...
                      <c:if test="${totalPage>0}">
                         [<a href="priorEnglishAgencyAction!searchParticipateSimulationExamInfor?pageNo=1  & temp=1"><b>首页</b></a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="priorEnglishAgencyAction!searchParticipateSimulationExamInfor?pageNo=${currentPage-1}  & temp=1"><b>上一页</b></a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="priorEnglishAgencyAction!searchParticipateSimulationExamInfor?pageNo=${currentPage+1}  & temp=1"><b>下一页</b></a>]
                          </c:if>
         
                         [<a href="priorEnglishAgencyAction!searchParticipateSimulationExamInfor?pageNo=${totalPage}  & temp=1"><b>尾页</b></a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
