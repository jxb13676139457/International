			    		  ...
			    		  $.ajax(		  
					    	      {
					    	    	  ...
					    	    	  type:"post",
					    	    	  url:"http://localhost:8080/Graduate/policyAction!addObject",
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>添加政策法规</li>
					</ol>
				</div>
			</div>
                                ...
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  <form class="form-validate form-horizontal" method="post" id="policyForm" action="policyAction!addPolicy" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                       ...
                                       <div class="form-group ">
                                         <div  style="margin-left:250px;margin-top:-10px">
                                          <label for="cname" class="control-label col-lg-2"><b>上传政策法规</b><span class="required" style="color:red">*</span></label>
                                          <div class="col-lg-10">
