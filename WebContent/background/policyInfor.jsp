		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i>维护政策法规信息</li>
					</ol>
				</div>
			</div>
		          ...
		          <s:if test="1==1"> 
                   ...
                   <c:if test="${totalPage>0}">
                         ...
                         <c:if test="${currentPage>1}">
                             [<a href="policyAction?pageNo=${currentPage-1}">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="policyAction?pageNo=${currentPage+1}">下一页</a>]
                          </c:if>
         
                         [<a href="policyAction?pageNo=${totalPage}">尾页</a>]	
                      ...
                      <s:else>
                           <c:if test="${totalPage>0}">
                         [<a href="policyAction!searchInformationbyTime?pageNo=1 & temp=1">首页</a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="policyAction!searchInformationbyTime?pageNo=${currentPage-1} & temp=1">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="policyAction!searchInformationbyTime?pageNo=${currentPage+1} & temp=1">下一页</a>]
                          </c:if>
         
                         [<a href="policyAction!searchInformationbyTime?pageNo=${totalPage} & temp=1">尾页</a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
