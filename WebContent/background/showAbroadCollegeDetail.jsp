		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i> 修改国外学院信息</li>
					</ol>
				</div>
			</div>
                          ...
                          <div class="panel-body">
                              <div class="form">
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  <form class="form-validate form-horizontal" method="post" id="AbroadCollegeForm" action="">
									...
									<div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                      <div  style="margin-left:250px;margin-top:-10px">
                                          <label for="cemail" class="control-label col-lg-2"><b>备注</b><span class="required" style="color:red">*</span></label>
                                          <div class="col-lg-10">
                                           <%--    <input class="form-control"  type="text" name="updateCollege.status"  value="${sessionScope.currentCollege.status }"/> --%>
                                                <select name="updateCollege.status"  style="width:100px;height:30px">
                                                 
                                                    <option selected>有签约</option>
                                                     <option>无签约</option>
