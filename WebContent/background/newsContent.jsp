                    ...
                    <li class="dropdown pull-right">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                             ...
                             <span  style="color:white"><s:property value="#session.adminUser.name"/></span>
                            <b class="caret"></b>
                        </a>
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
                   ...
                   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="studentInformationAction?status=1">维护国际学生信息</a></li>
                  ...
                  <li class="sub-menu">
                   ...
                   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="loginUserInformationAction">维护操作员信息</a></li>                          
                      </ul>
                  </li>    
              </ul>
              <!-- sidebar menu end-->
