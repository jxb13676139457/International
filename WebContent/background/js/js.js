	 ...
	 $.ajax(			    		
   	      {
   	    	  ...
   	    	  success: function(data){			
	    	    		 ...
	    	    		 var html="";
	    	    		 html=html +'<option selected>--请选择机构--</option>';
		  ...
		  $.ajax(		  
	    	      {
	    	    	  ...
	    	    	  success: function(data){
	    	    			 ...
	    	    			 var html="";
		    	    		 html=html +'<option selected>--请选择开始时间--</option>';
		  ...
		  $.ajax(		  
	    	      {
	    	    	  ...
	    	    	  success: function(data){
	    	    			 ...
	    	    			 var html="";
		    	    		 html=html +'<option selected>--请选择结束时间--</option>';
		  ...
		  $.ajax(		  
	    	      {
	    	    	  ...
	    	    	  success: function(data){
	    	    			 ...
	    	    			 var html="";
		    	    		 html=html +'<option selected>--请选择课时--</option>';
		  ...
		  $.ajax(		  
	    	      {
	    	    	  ...
	    	    	  success: function(data){
	    	    			 ...
	    	    			 var html="";
		    	    		 html=html +'<option selected>--请选择学期--</option>';
	 		  ...
	 		  $.ajax(		  
	 	    	      {
	 	    	    	  ...
	 	    	    	  success: function(data){
	 	    	    			 ...
	 	    	    			 var html="";
	 		    	    		 html=html +'<option selected>--请选择考试时间--</option>';
