  ...
  <head>
    ...
    <![endif]-->
			...
			<script type="text/javascript">
			      ...
			      function toSubmit(){
			    	  var formData = new FormData($( "#policyForm" )[0]);  // 要求使用的html对象
			    		  $.ajax(		  
					    	      {
					    	    	  
					    	    	  type:"post",
					    	    	  url:"http://localhost:8080/Graduate/policyAction!updateInfor",
                                ...
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  <form class="form-validate form-horizontal" method="post" id="policyForm"  action="" enctype="multipart/form-data">
                                      ...
                                      <div  style="margin-left:250px;margin-top:-10px">
                                       ...
                                       <div class="form-group ">
                                         <div  style="margin-left:250px;margin-top:-10px">
                                          <label for="cname" class="control-label col-lg-2"><b>重新上传政策法规</b><span class="required" style="color:red">*</span></label>
                                          <div class="col-lg-10">
