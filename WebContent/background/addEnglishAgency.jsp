...
<%--       
			...
			<script type="text/javascript">
			      ...
			      function toSubmit(){
			    	  ...
			    	  var reserve1 = dojo.widget.byId("reserve1").getValue();
			    		  ...
			    		  $.ajax(		  
					    	      {
					    	    	  ...
					    	    	  type:"post",
					    	    	  url:"http://localhost:8080/Graduate/englishAgencyAction!addObject.action",
					    	    	  data:{agencyName:agencyName,reserve1:reserve1,reserve2:reserve2,reserve3:reserve3},
					    	    	  dataType:"json",	
					    	    	  async:false,
