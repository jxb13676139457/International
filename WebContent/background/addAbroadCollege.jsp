		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>添加国外学院</li>
					</ol>
				</div>
			</div>
                          ...
                          <div class="panel-body">
                              <div class="form">
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  ...
                                  <form class="form-validate form-horizontal" id="AbroadCollegeForm" method="post" action="">                                                         
                                      ...
                                      <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control"  type="text" style="width:300px" name="addCollege.type" />
                                          </div>
                                          </div> 
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            ...
                                            <div class="form-group ">
                                               <div  style="margin-left:250px;margin-top:-10px">
                                          <label for="cemail" class="control-label col-lg-2"><b>状态</b><span class="required" style="color:red">*</span></label>
                                          <div class="col-lg-10">
                                              <select name="addCollege.status"  style="width:100px;height:30px"  required>
