			    		  ...
			    		  $.ajax(		  
					    	      {
					    	    	  ...
					    	    	  type:"post",
					    	    	  url:"http://localhost:8080/Graduate/participateTrainingAction!addObject",
					    	    	  data:{grade:grade,profession:profession,studentNo:studentNo,className:className,agencyName:agencyName,startTime:startTime,outTime:outTime,courseHours2:courseHours2,semester:semester},
					    	    	  dataType:"json",	
					    	    	  async:false,
		  ...
		  <div class="row">
				<div class="col-lg-12">
			     ...
			     <button type="button" class="btn btn-information" style="width:100px;height:30px;font-size:15px">
                            <a href="participateTrainingAction"><b>返回上页</b></a></button>
              <!-- Form validations -->              
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
