		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>修改模拟考试的信息</li>
					</ol>
				</div>
			</div>
                          ...
                          <div class="panel-body">
                              <div class="form">
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  <form class="form-validate form-horizontal" method="post" action="simulationExamAction!updateInfor.action">
                                      ...
                                      <div  style="margin-left:250px;margin-top:-10px">
                                       ...
                                       <div  style="margin-left:250px;margin-top:-10px">
                                          ...
                                          <div class="col-lg-10">
                                              <sx:datetimepicker name="updateUser.time" displayFormat="yyyy-MM-dd" value="simulationTime"/>
                                          </div>
                                          </div>
                                      </div>
