		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i>维护通知信息</li>
					</ol>
				</div>
			</div>
                ...
                <ul class="nav top-menu">                    
                    <li>
                       <form class="navbar-form" action="noticeAction?pageNo=1" method="post">
                          ...
                          <button type="button" class="btn btn-default" style="width:80px;height:30px">
                            <a href="exportNoticeExcel?searchName=${noticeTime}"><i class="icon_upload"></i>&nbsp;&nbsp;<b>导出</b></a></button>
		       ...
		       <div  style="text-align:center">
		          <s:if test="1==1"> 
                   <c:if test="${totalPage>0}">
                      ...
                      <s:else>
                          <c:if test="${totalPage>0}">
                         [<a href="noticeAction!searchInformationbyTime?pageNo=1 & temp=1">首页</a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="noticeAction!searchInformationbyTime?pageNo=${currentPage-1} & temp=1">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="noticeAction!searchInformationbyTime?pageNo=${currentPage+1} & temp=1">下一页</a>]
                          </c:if>
         
                         [<a href="noticeAction!searchInformationbyTime?pageNo=${totalPage} & temp=1">尾页</a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
