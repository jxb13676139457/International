    ...
    <!--      <img src="img/logo3.png" style="width:100px;height:50px" class="col-sm-4" > -->
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i>维护国外院校活动信息</li>
					</ol>
				</div>
			</div>
          ...
          <!--           <li style="margin-top:10px">
                       <form class="navbar-form" action="abroadCollegeActivitiesAction!searchInformationbyName" method="post">
                            <input class="form-control" name="searchCollegeName" placeholder="输入查找的国外院校" type="text" required/>
		       ...
		       <div  style="text-align:center">
		          <s:if test="1==1"> 
                   <c:if test="${totalPage>0}">
                      ...
                      <s:else>
                       <c:if test="${totalPage>0}">
                         [<a href="abroadCollegeActivitiesAction!searchInformationbyNTA?pageNo=1 & temp=1">首页</a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="abroadCollegeActivitiesAction!searchInformationbyNTA?pageNo=${currentPage-1} & temp=1">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="abroadCollegeActivitiesAction!searchInformationbyNTA?pageNo=${currentPage+1} & temp=1">下一页</a>]
                          </c:if>
         
                         [<a href="abroadCollegeActivitiesAction!searchInformationbyNTA?pageNo=${totalPage} & temp=1">尾页</a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
