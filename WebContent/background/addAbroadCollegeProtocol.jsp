  ...
  <head>
    ...
    <![endif]-->
     ...
     function toAgencyName(){
       ...
       var agencyName= $("#college").find("option:selected").text(); 
       
       $("#collegeName").val(agencyName);
     }
                              ...
                              <div class="form">
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  ...
                                  <form class="form-validate form-horizontal" id="uploadProtocol" method="post" action="" enctype="multipart/form-data">                                                         
                                        ...
                                        <input class="form-control" id="collegeName" name="collegeName"  type="hidden" style="width:300px" required/>                   
                                        
                                           <div class="form-group ">
                                            <div  style="margin-left:250px;margin-top:-10px">
                                          <label for="cname" class="control-label col-lg-2"><b>国外学院</b><span class="required" style="color:red">*</span></label>
                                          <div class="col-lg-10">
                                               <select id="college" style="width:300px;height:35px;border-radius:5px;-webkit-border-radius:3px;-moz-border-radius:3px;"
