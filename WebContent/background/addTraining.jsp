		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>添加雅思培训计划</li>
					</ol>
				</div>
			</div>
                                        ...
                                        <div  style="margin-left:250px;margin-top:-10px">
                                          ...
                                          <div class="col-lg-10">
                                            <!--   <input class="form-control" name="agencyName"  type="text" required/> -->
                                                 <select id="agencyName" name="agencyName" style="width:300px;height:35px;border-radius:5px;-webkit-border-radius:3px;-moz-border-radius:3px;"></select> 
                                          </div>
                                          </div>
                                      </div>
