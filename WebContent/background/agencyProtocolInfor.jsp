		  ...
		  <div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i>维护雅思协议的信息</li>
					</ol>
				</div>
			</div>
		       ...
		       <div  style="text-align:center">
		          <s:if test="1==1"> 
                   <c:if test="${totalPage>0}">
                      ...
                      <s:else>
                <c:if test="${totalPage>0}">
                         [<a href="agencyProtocolAction!searchInformation?pageNo=1 & temp=1">首页</a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="agencyProtocolAction!searchInformation?pageNo=${currentPage-1} & temp=1">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="agencyProtocolAction!searchInformation?pageNo=${currentPage+1} & temp=1">下一页</a>]
                          </c:if>
         
                         [<a href="agencyProtocolAction!searchInformation?pageNo=${totalPage} & temp=1">尾页</a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
