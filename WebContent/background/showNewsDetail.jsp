			    		  ...
			    		  $.ajax(		  
					    	      {
					    	    	  ...
					    	    	  type:"post",
					    	    	  url:"http://localhost:8080/Graduate/newsAction!updateInfor.action",
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>修改新闻公告</li>
					</ol>
				</div>
			</div>
                              ...
                              <div class="form">
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  <form class="form-validate form-horizontal" method="post" id="newsForm" action="newsAction!updateNewsInfor">
                                    ...
                                    <%--    <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">新闻内容1<span class="required" style="color:red">*</span></label>
                                          <div class="col-lg-10">
                                              <textarea rows="10" cols="130" name="updateUser.content_one">${sessionScope.currentUser.content_one }</textarea>
                                          </div>
                                      </div>
                                        ...
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea rows="10" cols="130" name="updateUser.content_two">${sessionScope.currentUser.content_two }</textarea>
                                          </div>
                                      </div>
                                          ...
                                          <div class="col-lg-10">
                                              <textarea rows="10" cols="130" name="updateUser.content_three">${sessionScope.currentUser.content_three}</textarea>
                                          </div>
                                      </div>
