			    		  ...
			    		  $.ajax(		  
					    	      {
					    	    	  ...
					    	    	  type:"post",
					    	    	  url:"http://localhost:8080/Graduate/noticeAction!addObject",
					    	    	  data:{title:title,time:time,source:source,author:author,content:content},
					    	    	  dataType:"json",	
					    	    	  async:false,
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>添加通知公告</li>
					</ol>
				</div>
			</div>
