		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>修改班级信息</li>
					</ol>
				</div>
			</div>
		  <button type="button" class="btn btn-information" style="width:100px;height:30px;font-size:15px">
                            <a href="internationalClassAction"><b>返回上页</b></a></button>
              <!-- Form validations -->              
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                                ...
                                <label  style="color:red">${ sessionScope.addUserError}</label>
                                  <form class="form-validate form-horizontal" method="post" action="internationClassAction!updateClassInfor">
                                   ...
                                   <%--              <select id="myYear" name="addClass.reserve1" value="${sessionScope.currentClass.reserve1 }" style="width:150px;height:35px;border-radius:5px;-webkit-border-radius:5px;-moz-border-radius :3px;">
                                                  ...
                                                  <option  selected="selected" }">${sessionScope.currentClass.reserve1 }</option>
                                                </select>  --%>
                                                </div>
                                          </div>
                                      </div>
