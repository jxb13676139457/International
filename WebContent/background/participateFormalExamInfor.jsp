...
<html lang="en">
  ...
  <script type="text/javascript">
			      ...
			      function toSubmitFormalExcel(){

			    	  var formData = new FormData($("#formalExcel")[0]);  // 要求使用的html对象
			    		  $.ajax(		  
					    	      {
					    	    	  
					    	    	  type:"post",
					    	    	  url:"http://localhost:8080/Graduate/participateFormalExamAction!importFormalExamExcel",
                ...
                <ul class="nav top-menu">                    
                    <li>
                     <form class="navbar-form" action="scoreAction" method="post">
                            ...
                            <a href="scoreAction?pageNo=1&search="><i class="icon_menu"></i>&nbsp;&nbsp;<b>显示全部</b></a></button>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
						   <form enctype="multipart/form-data" id="formalExcel" method="post">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" onclick="toSubmitFormalExcel()" >
								提交
							</button>
						</div>
					</div><!-- /.modal-content -->
		       ...
		       <div  style="text-align:center">
		          <s:if test="1==1"> 
                   <c:if test="${totalPage>0}">
                      ...
                      <s:else>
                         <c:if test="${totalPage>0}">
                         [<a href="participateFormalExamAction!searchInformation?pageNo=1 & temp=1">首页</a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="participateFormalExamAction!searchInformation?pageNo=${currentPage-1} & temp=1">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="participateFormalExamAction!searchInformation?pageNo=${currentPage+1} & temp=1">下一页</a>]
                          </c:if>
         
                         [<a href="participateFormalExamAction!searchInformation?pageNo=${totalPage} & temp=1">尾页</a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
                      </s:else>
                  </div>
