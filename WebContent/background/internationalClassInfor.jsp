    ...
    <![endif]-->
        ...
        <!-- 判断有没有重复名字的管理员-->
			...
			%>
			    ...
			    <%
			     String update=(String)session.getAttribute("updateClassInfor");
			     if(update!=null)
			     {
			 %>
			...
			<%
			     session.setAttribute("updateClassInfor",null);
			     }
			%>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i>维护班级信息</li>
                    ...
                    <li>
                        <form class="navbar-form" action="internationClassAction?pageNo=1" method="post">
                            ...
                            <a href="internationClassAction?searchClassName=&pageNo=1"><i class="icon_menu"></i>&nbsp;&nbsp;<b>显示全部</b></a></button>
                                 ...
                                 <button type="button" class="btn btn-default" style="width:80px;height:30px">
                            <a href="excelAction!exportInterClass"><i class="icon_upload"></i>&nbsp;&nbsp;<b>导出</b></a></button>
                        </form>
