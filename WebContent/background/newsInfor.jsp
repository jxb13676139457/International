		          ...
		          <s:if test="1==1"> 
                   <c:if test="${totalPage>0}">
                         ...
                         <c:if test="${currentPage>1}">
                             [<a href="newsAction?pageNo=${currentPage-1}">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="newsAction?pageNo=${currentPage+1}">下一页</a>]
                          </c:if>
         
                         [<a href="newsAction?pageNo=${totalPage}">尾页</a>]	
                      ...
                      <s:else>
                           ...
                           <c:if test="${totalPage>0}">
                         [<a href="newsAction!searchInformationbyTime?pageNo=1 & temp=1">首页</a>]
         
                         <c:if test="${currentPage>1}">
                             [<a href="newsAction!searchInformationbyTime?pageNo=${currentPage-1} & temp=1">上一页</a>]
                        </c:if>
         
                         <c:if test="${currentPage<totalPage}">
                            [<a href="newsAction!searchInformationbyTime?pageNo=${currentPage+1} & temp=1">下一页</a>]
                          </c:if>
         
                         [<a href="newsAction!searchInformationbyTime?pageNo=${totalPage} & temp=1">尾页</a>]	
                                                                                                     第${currentPage}页/共${totalPage}页
                      </c:if>
                      </s:else>
                  </div>
